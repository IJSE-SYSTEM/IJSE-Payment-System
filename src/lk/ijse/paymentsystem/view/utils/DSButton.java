...
public class DSButton {
    ...
    public DSButton(Container container) {
        this.container = container;
    }

    public void convertAllJButtonsToDSButtons() {
        DSButton.this.convertAllJButtonsToDSButtons(container);
    }

    private void convertAllJButtonsToDSButtons(Container container) {

        for (Component com : container.getComponents()) {

            if (com instanceof JButton) {

                // DSra's Button's Default States
...
//                        }
            ...
            if (com instanceof Container) {  // To get buttons inside another continaer in this container
                convertAllJButtonsToDSButtons((Container) com);
            }
