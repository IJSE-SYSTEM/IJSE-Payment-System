 ...
 */
package lk.ijse.paymentsystem.view.utils;
...
public class DSTable {
    ...
    private DSTableCellRenderer cellRenderForBoolean;
    private ArrayList<DSTableCellRenderer> cellRenderForObjects;

    public DSTable(JTable tbl) {
        this.tbl = tbl;
    ...
    public void initTable() {
        ...
        cellRenderForBoolean = new DSTableCellRenderer(DSTableCellRenderer.ColumnTypes.BOOLEAN, Color.WHITE, Color.BLACK, SwingConstants.CENTER);
        ...
        for (int i = 0; i < tbl.getColumnCount(); i++) {
            if (tbl.getColumnClass(i) != Boolean.class) {
                DSTableCellRenderer cellRender = new DSTableCellRenderer(DSTableCellRenderer.ColumnTypes.OBJECT, Color.WHITE, Color.BLACK, SwingConstants.LEFT);
    ...
    private void setMouseHoverForCellRenderObjects(boolean enable) {
        for (DSTableCellRenderer cellRenderForObject : cellRenderForObjects) {
    ...
    private static class DSTableCellRenderer extends DefaultTableCellRenderer {
        ...
        public DSTableCellRenderer(ColumnTypes columnType, Color backgroundColor, Color foregroundColor, int alignment) {
            colType = columnType;
