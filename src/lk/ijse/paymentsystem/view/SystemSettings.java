...
//        setIconImage(frameIcon.getImage());
    ...
    private void initComponents() {
        ...
        btnSave.setIcon(new javax.swing.ImageIcon(getClass().getResource("/lk/ijse/paymentsystem/icons/add.png"))); // NOI18N
        btnSave.setMnemonic('S');
        btnSave.setText("Save Database Details");
        btnSave.setToolTipText("Click to determine the status of colud connection");
    ...
    private void btnTestConnectionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTestConnectionActionPerformed
        ...
        Connection conn = (Connection) ConnectionFactory.getInstance().getConnection();
        if (conn != null) {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        try {
            ...
            // Change
            Object ip = myAppSettings.setProperty("ip", txtIPAddress.getText());
            Object port = myAppSettings.setProperty("port", txtPort.getText());
            Object username = myAppSettings.setProperty("username", txtUsername.getText());
            Object password = myAppSettings.setProperty("password", txtPassword.getText());
            Object database = myAppSettings.setProperty("database", txtDatabase.getText());
            
            FileWriter writer = new FileWriter(myFile);
            myAppSettings.store(writer, "");

            if (ip != null || port != null || username != null || password != null|| database != null) {
                JOptionPane.showMessageDialog(null, "Database Updated");
            }else{
                JOptionPane.showMessageDialog(null, "Database did not update");
            }
